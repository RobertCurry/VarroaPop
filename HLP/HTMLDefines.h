...
#define HID_MOUSELABEL                          0x10066
#define HID_CREATE_PROPSHEET                    0x18003
#define HID_SHOW_PROPSHEET                      0x18004
#define HID_VIEW_PARAMETERS                     0x18005
#define HID_FILE_NEW_NEWSESSION                 0x18006
#define HID_FILE_NEW_NEWCOLONY                  0x18007
#define HID_SELECT_GRAPH                        0x18009
#define HID_VIEW_PLOTDATA                       0x1800A
#define HID_FILE_SAVE_SESSION                   0x1800B
#define HID_FILE_SAVE_RESULTS                   0x1800D
#define HID_VIEW_COMBREMOVALDATE                0x18011
#define HID_VIEW_DATA_FREQ                      0x18012
#define HID_VIEW_OPTIONS                        0x18013
#define HID_WEATHER_CREATENEWWEATHERFILE        0x18014
#define HID_WEATHER_EDITCURRENTWEATHERFILE      0x18015
#define HID_WEATHER_EDITWEATHERFILEFROMDISK     0x18016
#define HID_WEATHER_FILE_SAVEAS                 0x18019
#define HID_WEATHER_FILE_EXIT                   0x1801A
#define HID_VIEW_ZOOMIN                         0x1801B
#define HID_VIEW_ZOOMOUT                        0x1801C
#define HID_WEATHER_FILE_OPEN                   0x1801D
#define HID_WEATHER_FILE_SAVE                   0x1801E
#define HID_BUTTON32800                         0x18020
#define HID_BUTTON32801                         0x18021
#define HID_BUTTON32802                         0x18022
#define HID_BUTTON32806                         0x18026
#define HID_HELP_REPORTAPROBLEM                 0x18027
#define HID_BUTTON32810                         0x1802A
#define HID_BUTTON_COLEXPAND                    0x1802A
#define HID_BUTTON32811                         0x1802B
#define HID_BUTTON_COLREDUCE                    0x1802B
#define HID_VIEW_SHOWWARNINGS                   0x1802C
#define HID_INDICATOR_WEATHER                   0x1E705
#define HID_INDICATOR_RES_FREQ                  0x1E707
#define HID_INDICATOR_SESSION                   0x1E708
 
// Prompts (IDP_*) 
 
// Resources (IDR_*) 
#define HIDR_MAINFRAME                          0x20080
#define HIDR_VARROATYPE                         0x20081
#define HIDR_CHARTMENU                          0x200BB
#define HIDR_MENUWEATHER                        0x200D2
#define HIDR_PRINTER                            0x2800F
#define HIDR_FILE                               0x28010
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_VARROAPOP_FORM                     0x20065
#define HIDD_COLONY_DATA_FORM                   0x20066
#define HIDD_SIMULATION_FORM                    0x20067
#define HIDD_ACTION_FORM                        0x2006B
#define HIDD_CREATE_HEADER                      0x20086
#define HIDD_SIMULATION_BAR                     0x20087
#define HIDD_IMMIGRATION                        0x20093
#define HIDD_GRAPHDIALOG                        0x200A8
#define HIDD_SELECT_GRAPHS                      0x200AA
#define HIDD_PROGRESS                           0x200AD
#define HIDD_SPLASH                             0x200B5
#define HIDD_OLECTRAGRAPHDLG                    0x200B9
#define HIDD_REMOVECOMB                         0x200CB
#define HIDD_OPTIONS                            0x200CC
#define HIDD_WEATHEREDIT                        0x200D0
#define HIDD_PROPPAGE_MEDIUM                    0x200E1
#define HIDD_WEATHER_FORM1                      0x200E2
#define HIDD_ACTION_FORM1                       0x200E3
#define HIDD_SPAN_VALUE                         0x200E4
#define HIDD_ACTION_FORM2                       0x200E5
#define HIDD_PESTICIDE_PAGE                     0x200E6
#define HIDD_PESTICIDE_ADD                      0x200E7
#define HIDD_RESOURCE_PAGE                      0x200E8
