...
class CGCMemDC : public CDC
{
public:

    // constructor sets up the memory DC
    CGCMemDC(CDC* pDC) : CDC()
    {
        ASSERT(pDC != NULL);
    ...
    CGCMemDC* operator->() {return this;}
        
    // Allow usage as a pointer
    operator CGCMemDC*() {return this;}

private:
    CBitmap  m_bitmap;      // Offscreen bitmap
    CBitmap* m_pOldBitmap;  // bitmap originally found in CGCMemDC
